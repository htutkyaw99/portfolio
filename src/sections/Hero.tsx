  ...
  return (
    ...
    >
      ...
      <ul className="flex items-center justify-center gap-3">
        <li>
          <a
            href="https://www.linkedin.com/in/yehtutkyaw99?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            target="_blank"
          >
            <svg
        ...
        <li>
          <a
            href="https://www.instagram.com/htutkyaw_?igsh=bzVmN25qZnN3a3h6"
            target="_blank"
          >
            <svg
              className="w-8 h-8 text-gray-800 "
        ...
        <li>
          <a href="https://github.com/htutkyaw99" target="_blank">
            <svg
              className="w-8 h-8 text-gray-800"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
